...
.Open your terminal inside that directory and compile all files:javac Main.java Hotel.java Room.java Customer.java Reservation.java Payment.java3. 
**Launch the Application**:
   ```bash
java Main
```
🎮 How to Use
When launched, follow the interactive console text prompt:
